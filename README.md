...
(4 May 1997), as used for instance by the Simple Public Key Infrastructure (SPKI). It
...
A more readable  `advanced' form allowing white space and using convention and quoting to avoid byte counts,
is typically used when humans will need to work with it directly. Both forms can be read by the same **Read** operation.
